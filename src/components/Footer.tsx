      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-16 grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 md:gap-12">
          <div className="col-span-1 text-center sm:col-span-2 sm:text-left md:col-span-2">
            ...
            />
            <p className="mx-auto mb-6 max-w-sm text-sm text-gray-400 sm:mx-0">{description}</p>
            <div className="flex justify-center space-x-4 sm:justify-start">
              <a
                ...
                aria-label="Security Guru Facebook puslapis"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 transition-all hover:bg-primary hover:text-dark"
                aria-label="Security Guru Instagram puslapis"
              >
          ...
          <div className="text-center sm:text-left">
            <h3 className="mb-6 font-bold text-primary">Navigacija</h3>
          ...
          <div className="text-center sm:text-left">
            <h3 className="mb-6 font-bold text-primary">Rekvizitai</h3>
            <ul className="space-y-3 text-sm text-gray-400">
              <li>{company_details.company_name}</li>
              <li>Įmonės kodas: {company_details.company_code}</li>
              <li>{company_details.location}</li>
            </ul>
          </div>
        </div>
