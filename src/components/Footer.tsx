        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-6">
              <span className="material-symbols-outlined text-primary text-3xl mr-2">shield_lock</span>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li>
                <a href="#services" className="hover:text-white transition-colors">Paslaugos</a>
              </li>
              <li><a href="#about" className="hover:text-white transition-colors">Apie mus</a></li>
              <li>
                <a href="#shop" className="hover:text-white transition-colors">E-Parduotuvė</a>
              </li>
              <li>
